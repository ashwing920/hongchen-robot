...
function addxml.trigger (t)
  --add by uniax
  t.enabled=t.enabled or "n"
  t.regexp=t.regexp or "y"
  t.temporary=t.temporary or "y"
  t.sequence=t.sequence or "100"
  --add by uniax
...
function addxml.timer (t)
  ...
  t.temporary=t.temporary or "y"
  t.hour=t.hour or "0"
  t.minute=t.minute or "0"
  t.second=t.second or "0"
  --add by uniax
...
function addxml.macro (t)
  GeneralAdd (t, "macro", "macros")
end -- addxml.macro

function addxml.save (which, name)
